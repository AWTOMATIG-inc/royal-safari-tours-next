...
export default function EmploymentStatusesLoading() {
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          <div className="h-7 w-56 animate-pulse bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded" />
          <div className="h-4 w-72 animate-pulse bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded" />
        </div>
        <div className="h-10 w-48 animate-pulse bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded-xl" />
      </div>
