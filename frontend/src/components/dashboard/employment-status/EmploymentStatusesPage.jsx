  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <DashboardPageHeader
        ...
        description="Manage employment status categories and conditions."
        actionText="Add Employment Status"
        ...
        {employmentStatuses.length === 0 ? (
          <div className="p-12 text-center max-w-md mx-auto space-y-4">
            ...
            <p className="text-gray-500 font-medium font-inter text-base">
              No employment statuses found. Click above to create your first
              employment status.
            </p>
          </div>
        ) : (
