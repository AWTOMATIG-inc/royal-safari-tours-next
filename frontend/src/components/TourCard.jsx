...
export default function TourCard({
  ...
  return (
    <div className="group relative bg-white rounded-3xl border border-gray-200/90 overflow-hidden shadow-sm hover:shadow-lg hover:border-secondary/40 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between h-full font-body">
      <div>
