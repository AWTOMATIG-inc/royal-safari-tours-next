...
export default function TravelerGallerySection({ initialItems = [] }) {
  ...
  return (
    <section className="container py-12 sm:py-16 md:py-20 font-body">
      {/* Section Heading */}
      <Reveal variant="fadeUp" className="text-center max-w-2xl mx-auto mb-10 sm:mb-14 font-body">
        <SectionHeading
          subtitle="TRAVELER STORIES & MOMENTS"
          title="Capturing Royal Safari Expeditions"
        ...
        {destinations.length > 1 && (
          <div className="flex items-center justify-center gap-2 flex-wrap mt-8 font-body">
      ...
      {filteredItems.length === 0 ? (
        ...
        <RevealGroup className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 sm:gap-6 font-body">
          {filteredItems.map((item, idx) => (
            <RevealGroup.Item key={item.id || item._id || idx}>
              <div
