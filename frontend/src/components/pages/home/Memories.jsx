  ...
  return (
    <div className="bg-sand pb-10 font-body">
      <div
        ...
        className="bg-[linear-gradient(rgba(0,0,0,0.55),rgba(0,0,0,0.55)),url('/images/banners/memories_bg.webp')] bg-center min-h-[650px] sm:min-h-[750px] grid items-center"
      >
        <Reveal variant="blurReveal" className="w-full">
