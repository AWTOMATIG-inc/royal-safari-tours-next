...
export default function ContactQuickCards() {
  return (
    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 z-20 w-full max-w-6xl px-4 sm:px-6 md:px-10 lg:px-8">
      <div className="bg-white/95 backdrop-blur-md rounded-[16px] sm:rounded-[20px] shadow-xl border border-primary/5 p-5 sm:p-8 md:p-10">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 lg:gap-6 lg:divide-x divide-gray-100 font-subheading">

          {/* WhatsApp */}
          <div className="flex flex-col items-center text-center p-2 sm:p-4 lg:p-2">
            <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-secondary/10 text-secondary flex items-center justify-center mb-2 sm:mb-4">
              <Icon icon="akar-icons:whatsapp-fill" width="22" height="22" />
            </div>
            <h3 className="text-[13px] sm:text-lg font-bold text-primary mb-0.5 sm:mb-1">WhatsApp</h3>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-[11px] sm:text-sm font-semibold text-primary hover:text-accent transition-colors duration-300 flex items-center gap-1 group/link cursor-pointer"
            >
              <span>Chat Now</span>
          ...
          <div className="flex flex-col items-center text-center p-2 sm:p-4 lg:pt-2 lg:pl-6">
            <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-accent/10 text-accent flex items-center justify-center mb-2 sm:mb-4">
              <Icon icon="lucide:mail" width="22" height="22" />
            </div>
            <h3 className="text-[13px] sm:text-lg font-bold text-primary mb-0.5 sm:mb-1">Email</h3>
          ...
          {/* Call Us */}
          <div className="flex flex-col items-center text-center p-2 sm:p-4 lg:pt-2 lg:pl-6">
            <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-primary/5 text-primary flex items-center justify-center mb-2 sm:mb-4">
              <Icon icon="lucide:phone" width="20" height="20" />
            </div>
            <h3 className="text-[13px] sm:text-lg font-bold text-primary mb-0.5 sm:mb-1">Call Us</h3>
          ...
          {/* Our Office */}
          <div className="flex flex-col items-center text-center p-2 sm:p-4 lg:pt-2 lg:pl-6">
            <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-rose-50 text-rose-500 flex items-center justify-center mb-2 sm:mb-4">
              <Icon icon="lucide:map-pin" width="20" height="20" />
            </div>
            <h3 className="text-[13px] sm:text-lg font-bold text-primary mb-0.5 sm:mb-1">Our Office</h3>
