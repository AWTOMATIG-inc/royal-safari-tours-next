          ...
          <div className="relative z-10 w-full max-w-2xl p-[1px] bg-gradient-to-tr from-white/10 to-white/30 backdrop-blur-xl rounded-3xl shadow-2xl">
            <div className="rounded-[23px] bg-black/35 p-6 sm:p-10 md:p-12 text-center space-y-6 sm:space-y-8 font-subheading">
              ...
              <div className="pt-2">
                <Link
                  href="/contact"
                  className="group relative inline-flex items-center gap-2 bg-secondary hover:bg-accent text-white font-semibold text-sm tracking-wider uppercase px-8 py-4 rounded-full transition-all duration-300 shadow-[0_4px_20px_rgba(44,183,117,0.3)] hover:shadow-[0_4px_20px_rgba(222,141,61,0.3)] hover:-translate-y-0.5"
                >
                  Start Planning
