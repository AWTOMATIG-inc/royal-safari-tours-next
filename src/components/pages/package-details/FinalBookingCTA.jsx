...
export default function FinalBookingCTA({ tourPackage, onOpenBooking }) {
  ...
  return (
    <section className="relative py-20 sm:py-28 bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center max-w-3xl space-y-6 font-subheading">
        ...
        <p className="text-sm sm:text-base text-white/80 font-light font-body max-w-xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <button
            ...
            className="w-full sm:w-auto bg-secondary hover:bg-accent text-white font-semibold py-4 px-8 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2 text-xs sm:text-sm uppercase tracking-wider cursor-pointer shadow-lg hover:-translate-y-0.5"
          >
